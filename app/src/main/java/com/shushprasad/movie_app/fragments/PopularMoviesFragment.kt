...
class PopularMoviesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerViewPopularMovies =
            view.findViewById<RecyclerView>(R.id.recyclerViewPopularMovies)

        // recyclerViewPopularMovies.layoutManager = LinearLayoutManager(context)
        ...
        recyclerViewPopularMovies.adapter = movieAdapter
